function Home() {
  return (
    <div className="min-h-screen bg-[#0f172a] text-white text-center">
      <main>
        <h1 className="text-6xl font-semibold mb-16">Welcome to [name].</h1>
      </main>

      <div>
        <main className="text-center">
            <h1 className="text-3xl font-semibold mb-16">About</h1>
